            ...
            if (formattedSelection && formattedSelection.length > 0) {
                ...
                for (const selection of formattedSelection) {
                    if (
                        ...
                        selection.segmentRects.length > 0
                    ) {
                        ...
                        const highlightAnnotation = {
                            ...
                            color: ANNOTATION_COLORS.find(
                                (color) => color.name === 'Yellow',
                            )?.value,
                            strokeColor: ANNOTATION_COLORS.find(
                                (color) => color.name === 'Yellow',
                            )?.value,
                            opacity: 1,
                        ...
                        await annotationScope.importAnnotations([
                            {
                                annotation:
                                    highlightAnnotation as unknown as Parameters<
                ...
                for (const selection of formattedSelection) {
                    if (
                        ...
                        await annotationScope.importAnnotations([
                            {
                                annotation:
                                    underlineAnnotation as unknown as Parameters<
                                        typeof annotationScope.importAnnotations
                                    >[0][0]['annotation'],
                                ctx: undefined,
                            },
