...
import { LayoutGrid, FileText, Columns } from "lucide-react"
...
export function SidebarViewState({ view, onViewChange, isMobile }: SidebarViewStateProps) {
    return (
        <div className={isMobile ? "grid grid-cols-2 gap-2" : "grid grid-cols-3 gap-1"}>
            <Button
